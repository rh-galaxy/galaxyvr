...
public class GameStatus : MonoBehaviour
{
    ...
    /**/private Vector3 vOffset = new Vector3(-8.0f / 10.0f, -30.0f / 10.0f, -5.0f / 10.0f); //from camera (x,y)
    /**/private Vector3 vOffsetNoVR = new Vector3(-9.15f / 10.0f, -6.3f / 10.0f, -3.9f / 10.0f); //from camera (x,y)
    /**///private Vector3 vOffsetNoVR = new Vector3(-90.0f / 10, -6.3f / 10, -3.9f / 10); //from camera (x,y) used while recording video
