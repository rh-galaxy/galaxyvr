...
public class Planet : MonoBehaviour
{
    ...
    public void Init(int i_iPlanet)
    {
        ...
        switch (iPlanet)
        {
            ...
            case 6: oPlanet6.SetActive(true); break;
        }
    }
    ...
    void Update()
    {
        switch (iPlanet)
        {
            case 1: oPlanet1.transform.RotateAround(oPlanet1.transform.position, Vector3.up, 0.35f * Time.deltaTime); break;
            case 2: oPlanet2.transform.RotateAround(oPlanet2.transform.position, Vector3.right, 0.2f * Time.deltaTime); break;
            ...
            case 5: oPlanet5.transform.RotateAround(oPlanet5.transform.position, Vector3.up, 0.2f * Time.deltaTime); break;
            case 6: oPlanet6.transform.RotateAround(oPlanet6.transform.position, Vector3.up, 0.5f * Time.deltaTime); break;
        }
    }
}
