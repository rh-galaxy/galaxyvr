...
public class Menu : MonoBehaviour
{
    ...
    void Update()
    {
...
#if NOOCULUS
            oMenuAchievements = new C_Item2InMenu(new Vector3(0, -6.0f, 2.81f), vAroundPoint, -14, "Achievements", "Achievements", 30.0f, 11.5f);
            oMenuSetName = new C_Item2InMenu(new Vector3(0, -7.5f, 2.81f), vAroundPoint, -3, "Enter name", "SetName", 30.0f, 18.0f);
#endif
        ...
        if (keyboard != null && iLastInfo != 7) bTrigger = bTrigger || keyboard.hKey.isPressed || keyboard.enterKey.isPressed; //hkey emulates buttonclick, for easier use when mouse outside window
